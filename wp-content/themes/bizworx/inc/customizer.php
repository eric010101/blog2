...
function bizworx_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'background_color',
            array(
                'label'         => __('Background color', 'bizworx'),
                'section'       => 'colors',
    ...
    $wp_customize->add_setting(
        'header_title_1',
        array(
            'default' => __('Welcome to Bizworx', 'bizworx'),
    ...
    $wp_customize->add_setting(
        'header_subtitle_1',
        array(
            'default' => __('Feel free to look around', 'bizworx'),
			'sanitize_callback' => 'wp_filter_nohtml_kses',
        )
    );
    $wp_customize->add_control(
    ...
    $wp_customize->add_setting(
        'banner_button',
        array(
            'default' => __('Get started', 'bizworx'),
			'sanitize_callback' => 'wp_filter_nohtml_kses',
        )
    );
    $wp_customize->add_control(
	...
	//___WooCommerce Extra Options___//
    $wp_customize->add_section(
        'bizworx_woocommerce_extra',
        array(
            'title'     => __('WooCommerce Extra', 'bizworx'),
            'priority'  => 14,
        )
    );
    //Activate contact
    ...
    $wp_customize->add_control(
        ...
        array(
            'type' => 'checkbox',
            'label' => __('Show User and Cart icons in menu?', 'bizworx'),
            'section' => 'bizworx_woocommerce_extra',
            'priority' => 10,
        )
    );
	//Sidebar location
    $wp_customize->add_setting(
        ...
        array(
			'default' => 'right',
			'sanitize_callback' => 'bizworx_sanitize_wc_content'
        )       
    );
    $wp_customize->add_control(
        'wc_content_location',
        array(
            'type' => 'radio',
            'label' => __('Content position', 'bizworx'),
            'section' => 'bizworx_woocommerce_extra',
            'priority' => 10,
			'choices' => array(
